	...
	<div class="">
		<div class="row">
			...
			<div class="pull-right">
				...
				<button class="btn btn-default" type="button" onclick="window.parent.jModalClose();"><?php echo JText::_('JCANCEL') ?></button>
			</div>
		</div>
	</div>
	...
	<div class="">
		<div class="row">
			<div class="col-md-6 form-group">
				...
				<input type="text" id="f_url" value="" class="form-control" />
			</div>
			...
			<div class="col-md-6 form-group">
				...
				<select size="1" id="f_align" class="form-control">
		...
		<div class="row">
			<div class="col-md-6 form-group">
				...
				<input type="text" id="f_alt" value="" class="form-control" />
			</div>
			<div class="col-md-6 form-group">
				<label for="f_title"><?php echo JText::_('COM_MEDIA_TITLE') ?></label>
				<input type="text" id="f_title" value="" class="form-control" />
			</div>
		</div>
		<div class="row">
